...
PROJECT_NAME ?= provider-provider-cisco-aci
PROJECT_REPO ?= github.com/m-gran/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_REPO ?= https://github.com/CiscoDevNet/terraform-provider-aci
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-aci_v2.14.1
...
xpkg.build.provider-provider-cisco-aci: do.build.images
