...
import (
	...
	clusterv1beta1 "github.com/m-gran/provider-provider-cisco-aci/apis/cluster/v1beta1"
	namespacedv1beta1 "github.com/m-gran/provider-provider-cisco-aci/apis/namespaced/v1beta1"
)
...
const (
	...
	errUnmarshalCredentials = "cannot unmarshal provider-cisco-aci credentials as JSON"
)
